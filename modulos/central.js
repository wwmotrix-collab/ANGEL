...
(function (global) {
  ...
  const PERFIL_META = {
    ...
    master: { titulo: 'Central Master', subtitulo: 'Onboarding, planos, clientes e banco global para vender e replicar campanhas.', foco: 'Padronizar implantação e acelerar entrega ao cliente', cards: [ ['🏗️','Campanhas','Criar e configurar novas campanhas por candidato/município.','master-campanhas'], ['💰','Planos','Pacotes comerciais por módulos e nível de operação.','master-planos'], ['🤝','Clientes','Acompanhar contratos, status e implantação.','master-clientes'], ['🗄️','Banco global','Base reutilizável de locais, parâmetros e dados eleitorais.','master-banco'] ] },
  };
